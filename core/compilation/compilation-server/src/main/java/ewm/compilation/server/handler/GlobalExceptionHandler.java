package ewm.compilation.server.handler;

import ewm.compilation.server.dto.ApiErrorDto;
import ewm.compilation.server.exception.ConflictException;
import ewm.compilation.server.exception.DataIntegrityViolationException;
