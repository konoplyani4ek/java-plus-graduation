package ewm.place.server.handler;

import ewm.place.server.dto.ApiErrorDto;
import ewm.place.server.exception.ConflictException;
import ewm.place.server.exception.DataIntegrityViolationException;
import ewm.place.server.exception.NotFoundException;
import ewm.place.server.exception.ServiceUnavailableException;
import ewm.place.server.exception.ValidationException;
